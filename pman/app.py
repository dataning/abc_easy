...
def run_streaming_research(question):
    """Run research with real-time streaming output - ENHANCED FOR CONSISTENCY"""
    ...
    try:
        ...
        with StreamingOutputCapture(console_placeholder, stats_callback):
            ...
            research_result = {
                ...
                'fresh_agent': True,  # Mark as fresh agent
...
def main():
    ...
    st.markdown("*Hierarchical research system with **FIXED citation verification** and enhanced text formatting*")
